...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  settings: {
    ...
    setAutoDownloadEnabled: (enabled) => ipcRenderer.invoke("settings:setAutoDownloadEnabled", enabled),
    setAutoInstallOnQuitEnabled: (enabled) => ipcRenderer.invoke("settings:setAutoInstallOnQuitEnabled", enabled),
